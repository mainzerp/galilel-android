...
import galileltrum.messages.BaseMsg;
import galileltrum.messages.GetBalanceMsg;
import galileltrum.messages.GetHeader;
import galileltrum.messages.GetHistoryMsg;
import galileltrum.messages.GetTxMsg;
import galileltrum.messages.ListUnspentMsg;
import galileltrum.messages.Method;
import galileltrum.messages.SubscribeAddressMsg;
...
public class GalileltrumPeer implements IoHandler{

    private final Logger log;

    /** Peer data */
    private GalileltrumPeerData peerData;
    /**  */
    ...
    public GalileltrumPeer(GalileltrumPeerData peerData,IoManager ioManager,VersionMsg versionMsg) {
        this.peerData = peerData;
        this.ioManager = ioManager;
        this.versionMsg = versionMsg;
        this.log = LoggerFactory.getLogger(GalileltrumPeer.class.getName()+"-"+peerData.getHost());
    }
    ...
    public void connect() throws ConnectionFailureException, InterruptedException {
        if (isInitilizing.compareAndSet(false,true) && !isRunning.get()) {
            ...
            throw new IllegalStateException("GalileltrumPeer already initializing");
        }
    }
    ...
    public GalileltrumPeerData getPeerData() {
        return peerData;
    }
