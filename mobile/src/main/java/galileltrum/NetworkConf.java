...
public class NetworkConf {
    ...
    private static final String CLIENT_NAME = "galilel_mobile";
    ...
    private GalileltrumPeerData trustedHost;
    ...
    public GalileltrumPeerData getTrustedServer() {
        return trustedHost;
    }

    public void setTrustedServer(GalileltrumPeerData galileltrumPeerData) {
        this.trustedHost = galileltrumPeerData;
