...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final GalilelApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (GalilelContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + GalilelContext.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = ((GalilelModuleImp)application.getModule()).getWallet();
