package galilel.org.galilelwallet.ui.settings_backup_activity;
...
import galilel.org.galilelwallet.ui.backup_mnemonic_activity.MnemonicActivity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = galilelModule.backupWallet(backupFile, firstPassword);

            if (result){
                galilelApplication.getAppConf().setHasBackup(true);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    succedDialog.setOkBtnBackgroundColor(getColor(R.color.darkBrown3));
                }else {
                    succedDialog.setOkBtnBackgroundColor(ContextCompat.getColor(SettingsBackupActivity.this, R.color.darkBrown3));
                }
