package galilel.org.galilelwallet.ui.words_restore_activity;
...
import galilel.org.galilelwallet.ui.transaction_send_activity.MyFilterableAdapter;
import galilel.org.galilelwallet.ui.transaction_send_activity.MyTextWatcher;
...
public class RestoreWordsActivity extends BaseActivity {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        //Words
        mnemonicWords = galilelModule.getAvailableMnemonicWordsList();
        ...
        if (current < layouts.length) {
            ...
            try {
                            ...
                            public void onRightBtnClicked(SimpleTwoButtonsDialog dialog) {
                                ...
                                executorService.submit(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            // loading here..
                                            galilelModule.checkMnemonic(mnemonic);

                                            boolean isBip32 = check_bip32.isChecked();

                                            galilelModule.restoreWallet(mnemonic, GALI_WALLET_APP_RELEASED_ON_PLAY_STORE_TIME,!isBip32);
                                            ...
                                            public void run() {
                                                if (finalResult){
                                                    ...
                                                    if (galilelApplication.getAppConf().getPincode() != null){
                                                        ...
                                                        if(!galilelApplication.getAppConf().isAppInit()){
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    dialog.setRightBtnTextColor(getColor(R.color.darkBrown1));
                }else {
                    dialog.setRightBtnTextColor(ContextCompat.getColor(this, R.color.darkBrown1));
                }
                dialog.show();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public class ViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            if (position==0) {
                ...
                txt_bip32_message.setText(getString(R.string.restore_bip32_warning, GalilelContext.ENABLE_BIP44_APP_VERSION));
