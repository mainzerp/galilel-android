package galilel.org.galilelwallet.ui.pincode_activity;
...
import galilel.org.galilelwallet.ui.settings_pincode_activity.KeyboardFragment;
...
public class PincodeActivity extends BaseActivity implements KeyboardFragment.onKeyListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        if (galilelApplication.getAppConf().getPincode()!=null && !checkPin){
            goNext();
            finish();
        }
            ...
            if (key.getValue() < 10) {
                ...
                if (lastPos == 4) {
                    ...
                    if (!checkPin) {
                        ...
                        if(galilelApplication.getAppConf().getPincode().equals(pincode)){
