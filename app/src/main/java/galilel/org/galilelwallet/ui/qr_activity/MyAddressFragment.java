...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(GalilelModule galilelModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(galilelModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = GalilelApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String galilelUri = GalilelURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(galilelUri,address.toBase58());
            }
    ...
    public void setModule(GalilelModule module) {
        this.module = module;
    }
